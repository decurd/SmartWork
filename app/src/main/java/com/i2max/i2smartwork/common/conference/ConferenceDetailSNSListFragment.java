...
public class ConferenceDetailSNSListFragment extends Fragment {
    static String TAG = ConferenceDetailSNSListFragment.class.getSimpleName();
            ...
            public void loadMore(int itemsCount, final int maxLastVisiblePosition) {
                ...
                if (!checkNextLoading) {
                    if (mTotalCnt > mDataArray.size()) {
                        mListPage++;
                        loadRecyclerView(mTarObjTp, mTarObjId, mTarObjTtl, mTarCrtUsrId, mSearchStr);
                    }
...
//        });
    ...
    public void loadRecyclerView(String tarObjTp, String tarObjId, String tarObjTtl, String tarCrtUsrId, String searchStr) {
        mTarObjTp = tarObjTp;
        mTarObjId = tarObjId;
        ...
        I2ConnectApi.requestJSON(getActivity(), I2UrlHelper.SNS.getListSNSByObjectId(mTarObjTp, mTarObjId, "", String.format("%d", mListPage), mSearchStr))
