...
import com.i2max.i2smartwork.common.milestone.MilestoneListRecyclerViewAdapter;
...
public class WorkDetailMilestoneListFragment extends Fragment {
    static String TAG = WorkDetailMilestoneListFragment.class.getSimpleName();

    public boolean checkRefreshLoading = false;
    private List<LinkedTreeMap<String, Object>> mDataArray;
    protected MilestoneListRecyclerViewAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mTvEmpty.setText(getString(R.string.no_milestone_data_available));
...
//        mURV.enableLoadmore();
        ...
        mAdapter = new MilestoneListRecyclerViewAdapter(getActivity(), mDataArray);
    ...
    public void loadRecyclerView(String tarObjTp, String tarObjId, String tarObjTtl, String tarCrtUsrId, String curObjTp, String curObjId, String curCrtUsrId) {
        ...
        I2ConnectApi.requestJSON2Map(getActivity(), I2UrlHelper.Milestone.getListSnsMilestoneByObjectId(mTarObjId))
...
//                        DialogUtil.hideCircularProgressDialog();
                    ...
                    public void onNext(Map<String, Object> status) {
                        List<LinkedTreeMap<String, Object>> dataList = (List<LinkedTreeMap<String, Object>>) status.get("statusInfo");
                        if (dataList.size() > 0) {
                            mDataArray.clear();
