 ...
 */
public class TaskDetailMemberRecyclerViewAdapter
        extends RecyclerView.Adapter<TaskDetailMemberRecyclerViewAdapter.ViewHolder> {
    ...
    public TaskDetailMemberRecyclerViewAdapter(Context context, List<LinkedTreeMap<String, String>> items) {
        mContext = context;
        mValues = items;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mTvSelfIntro.setText(mContext.getString(R.string.task_member));
