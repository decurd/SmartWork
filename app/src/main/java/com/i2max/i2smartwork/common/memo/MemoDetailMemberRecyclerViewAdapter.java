 ...
 */
public class MemoDetailMemberRecyclerViewAdapter
        extends RecyclerView.Adapter<MemoDetailMemberRecyclerViewAdapter.ViewHolder> {
    ...
    public MemoDetailMemberRecyclerViewAdapter(Context context, List<LinkedTreeMap<String, String>> items) {
        mContext = context;
        mValues = items;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        String tpNm = FormatUtil.getStringValidate(item.get("usr_tp_cd"));
        String fnlApprYn = FormatUtil.getStringValidate(item.get("fnl_appr_yn"));
        if("CRTR".equals(tpNm)) {
            tpNm = "신청자";
        } else if("REFC".equals(tpNm)) {
