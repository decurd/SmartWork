...
import com.i2max.i2smartwork.common.memo.MemoListRecyclerViewAdapter;
...
public class WorkDetailMemoListFragment extends Fragment {
    static String TAG = WorkDetailMemoListFragment.class.getSimpleName();
...
//        mURV.enableLoadmore();
        ...
        mAdapter = new MemoListRecyclerViewAdapter(getActivity(), mDataArray);
    ...
    public void loadRecyclerView(String tarObjTp, String tarObjId, String tarObjTtl, String tarCrtUsrId, String curObjTp, String curObjId, String curCrtUsrId) {
        ...
        I2ConnectApi.requestJSON2Map(getActivity(), I2UrlHelper.Memo.getListSnsMemoByObjectId(mTarObjTp, mTarObjId))
...
//                        DialogUtil.hideCircularProgressDialog();
                    ...
                    public void onNext(Map<String, Object> status) {
                        ...
                        List<LinkedTreeMap<String, Object>> datalist = (List<LinkedTreeMap<String, Object>>) statusInfo.get("memoList");
